...
#ifndef AI_MODEL_PENDULUM_H
#define AI_MODEL_PENDULUM_H
#pragma once
...
/******************************************************************************/
#define AI_MODEL_PENDULUM_MODEL_NAME          "model_pendulum"
#define AI_MODEL_PENDULUM_ORIGIN_MODEL_NAME   "model"

/******************************************************************************/
#define AI_MODEL_PENDULUM_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MODEL_PENDULUM_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MODEL_PENDULUM_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MODEL_PENDULUM_IN_NUM        (1)

AI_DEPRECATED
#define AI_MODEL_PENDULUM_IN \
  ai_model_pendulum_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_PENDULUM_IN_SIZE { \
  AI_MODEL_PENDULUM_IN_1_SIZE, \
}
#define AI_MODEL_PENDULUM_IN_SIZE_BYTES { \
  AI_MODEL_PENDULUM_IN_1_SIZE_BYTES, \
}
#define AI_MODEL_PENDULUM_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_MODEL_PENDULUM_IN_1_HEIGHT      (100)
#define AI_MODEL_PENDULUM_IN_1_CHANNEL     (3)
#define AI_MODEL_PENDULUM_IN_1_SIZE        (100 * 3)
#define AI_MODEL_PENDULUM_IN_1_SIZE_BYTES  (1200)

/******************************************************************************/
#define AI_MODEL_PENDULUM_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MODEL_PENDULUM_OUT \
  ai_model_pendulum_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MODEL_PENDULUM_OUT_SIZE { \
  AI_MODEL_PENDULUM_OUT_1_SIZE, \
}
#define AI_MODEL_PENDULUM_OUT_SIZE_BYTES { \
  AI_MODEL_PENDULUM_OUT_1_SIZE_BYTES, \
}
#define AI_MODEL_PENDULUM_OUT_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_MODEL_PENDULUM_OUT_1_CHANNEL     (1)
#define AI_MODEL_PENDULUM_OUT_1_SIZE        (1)
#define AI_MODEL_PENDULUM_OUT_1_SIZE_BYTES  (4)

/******************************************************************************/
#define AI_MODEL_PENDULUM_N_NODES (8)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup model_pendulum
 ...
 * @ref ai_model_pendulum_create. Both the activations memory buffer 
 ...
 * using @ref ai_model_pendulum_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_pendulum_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_model_pendulum_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MODEL_PENDULUM_*
 * defines into file @ref model_pendulum.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_model_pendulum_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MODEL_PENDULUM_H */
