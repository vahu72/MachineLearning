...
#define AI_DUMMYNN_ORIGIN_MODEL_NAME   "model"
...
#define AI_DUMMYNN_IN_1_FORMAT      AI_BUFFER_FORMAT_FLOAT
#define AI_DUMMYNN_IN_1_HEIGHT      (100)
#define AI_DUMMYNN_IN_1_CHANNEL     (3)
#define AI_DUMMYNN_IN_1_SIZE        (100 * 3)
#define AI_DUMMYNN_IN_1_SIZE_BYTES  (1200)
